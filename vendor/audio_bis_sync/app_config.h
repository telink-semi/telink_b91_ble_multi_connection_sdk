...
#pragma once
	...
	#define APP_AUDIO_USB_ENABLE                	1
#else
	#define APP_AUDIO_USB_ENABLE                	0
#endif
...
#define LL_FEATURE_PRIVATE_BIS_SYNC_RECEIVER		0   //Private BIS sync feature,use legScan to skip periodic adv
...
#define APP_DUMP_EN									!APP_AUDIO_USB_ENABLE /* dump debug and audio usb cannot be used at the same time */
...
#if (LE_AUDIO_DEMO_ENABLE)
	#define APP_AUDIO_BIS_INTERVEL      10 //ms
	#define APP_AUDIO_FRAME_SAMPLE      (APP_AUDIO_BIS_INTERVEL << 4)
	#define APP_AUDIO_FRAME_BYTES       (APP_AUDIO_FRAME_SAMPLE << 1)

	#define APP_AUDIO_COMP_BUFF_NUM     2
	#define APP_AUDIO_COMP_BUFF_LEN     (APP_AUDIO_FRAME_BYTES >> 3)    // 8:1

	#define APP_AUDIO_DMIC_ENABLE       1
	#if (APP_AUDIO_DMIC_ENABLE)
		#define PD4_INPUT_ENABLE				1
		#define PD5_INPUT_ENABLE				1
	#endif //APP_AUDIO_DMIC_ENABLE


	#if (APP_AUDIO_USB_ENABLE == 1)
		#define APPLICATION_DONGLE              1
		#if 1
			#define ID_VENDOR				0x248a			// for report
			#define ID_PRODUCT_BASE			0x8801			//AUDIO_HOGP
			#define STRING_VENDOR			L"Telink"
			#define STRING_PRODUCT			L"Telink LE Audio"
			#define STRING_SERIAL			L"TLSR9518"
		#else
			#define ID_VENDOR				0x248a			// for report
			#define ID_PRODUCT_BASE			0x8802			//AUDIO_HOGP
			#define STRING_VENDOR			L"Telink"
			#define STRING_PRODUCT			L"Telink LE Audio 2"
			#define STRING_SERIAL			L"TLSR9518_2"
		#endif
